  ...
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      ...
      if buffer.type_name() ==# 'model' || buffer.type_name('model-arb')
        ...
        syn keyword rubyRailsARAssociationMethod belongs_to has_one has_many has_and_belongs_to_many composed_of accepts_nested_attributes_for embeds_many embedded_in
